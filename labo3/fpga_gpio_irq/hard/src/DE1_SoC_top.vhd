...
architecture top of DE1_SoC_top is
    ...
    component qsys_system is
        port (
            ...
            -- Switchs
            in_switchs_export  : in    std_logic_vector(9 downto 0)  := (others => 'X'); -- export

            -- Keys
            in_keys_export     : in    std_logic_vector(3 downto 0)  := (others => 'X'); -- export

            -- Leds
            out_leds_export    : out   std_logic_vector(9 downto 0);                     -- export

            -- Hexs
            out_hex3_0_export  : out   std_logic_vector(31 downto 0);                    -- export
            out_hex5_4_export  : out   std_logic_vector(15 downto 0)                     -- export
        );
    end component qsys_system;

    --| Signals declarations   |--------------------------------------------------------------
    -- IOs needing inversion
    signal hex3_0_s : std_logic_vector(31 downto 0);
    signal hex5_4_s : std_logic_vector(15 downto 0);
...
---------------------------------------------------------
    ...
    u0 : component qsys_system
        port map (
            ...
            clk_clk            => CLOCK_50_i,           --        clk.clk

            -- DDR3 SDRAM
            memory_mem_a       => HPS_DDR3_ADDR_o,      --     memory.mem_a
            memory_mem_ba      => HPS_DDR3_BA_o,        --           .mem_ba
            memory_mem_ck      => HPS_DDR3_CK_P_o,      --           .mem_ck
            memory_mem_ck_n    => HPS_DDR3_CK_N_o,      --           .mem_ck_n
            memory_mem_cke     => HPS_DDR3_CKE_o,       --           .mem_cke
            memory_mem_cs_n    => HPS_DDR3_CS_N_o,      --           .mem_cs_n
            memory_mem_ras_n   => HPS_DDR3_RAS_N_o,     --           .mem_ras_n
            memory_mem_cas_n   => HPS_DDR3_CAS_N_o,     --           .mem_cas_n
            memory_mem_we_n    => HPS_DDR3_WE_N_o,      --           .mem_we_n
            memory_mem_reset_n => HPS_DDR3_RESET_N_o,   --           .mem_reset_n
            memory_mem_dq      => HPS_DDR3_DQ_io,       --           .mem_dq
            memory_mem_dqs     => HPS_DDR3_DQS_P_io,    --           .mem_dqs
            memory_mem_dqs_n   => HPS_DDR3_DQS_N_io,    --           .mem_dqs_n
            memory_mem_odt     => HPS_DDR3_ODT_o,       --           .mem_odt
            memory_mem_dm      => HPS_DDR3_DM_o,        --           .mem_dm
            memory_oct_rzqin   => HPS_DDR3_RZQ_i,       --           .oct_rzqin

            -- Switchs
            in_switchs_export  => SW_i,                 -- in_switchs.export

            -- Keys
            -- in_keys_export     => KEY_i,                --    in_keys.export
            in_keys_export     => keys_s,               --    in_keys.export

            -- Leds
            out_leds_export    => LEDR_o,               --   out_leds.export

            -- Hexs
            out_hex3_0_export  => hex3_0_s,             -- out_hex3_0.export
            out_hex5_4_export  => hex5_4_s              -- out_hex5_4.export
        );

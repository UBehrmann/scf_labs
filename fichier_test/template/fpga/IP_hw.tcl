# Platform Designer component — rename module to match exam IP name
package require -exact qsys 16.1

set_module_property NAME AXI4Lite_Convol
set_module_property VERSION 1.0
set_module_property DISPLAY_NAME AXI4Lite_Convol
...
add_fileset_file conv_engine_pkg.vhd VHDL PATH conv_engine_pkg.vhd
add_fileset_file conv_engine.vhd VHDL PATH conv_engine.vhd
